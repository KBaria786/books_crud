...
public class BooksController {
    ...
    public ResponseEntity<List<Book>> findAll(@Parameter(name = "page", description = "page")
        ...
        httpHeaders.add("X-Total-Count", bookService.getTotalCount().toString());
        return ResponseEntity.ok().headers(httpHeaders).body(bookService.findAll(page, limit));
    }
